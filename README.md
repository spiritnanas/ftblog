...
The idea here being that when you receive a certificate, you also receive the certificate that signed your certificate, all the way up to the Root CA for that certificate chain. 
